...
function stringToLines(string) {
  // There's an issue with the raw file reading and the unit tests,
  // so delay parsing the file contents until required
  if (!rowmans) {
    rowmans = convertFile(require('raw!' + '../font/rowmans.jhf'));
  }
